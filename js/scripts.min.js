...
function act_timer() {
	if (!(minutes_s == '00' && seconds_s == '00')) {
		...
		$('.timer .timer__container')
			.html("<div class='timer__item timer__item_hours'><div class='timer__item-tx'>" + hour_s + "</div><div class='timer__item-label'>jam</div></div><div class='timer__item timer__item_minutes'><div class='timer__item-tx'>" + minutes_sh + "</div><div class='timer__item-label'>minit</div></div><div class='timer__item timer__item_seconds'><div class='timer__item-tx'>" + seconds_s + "</div><div class='timer__item-label'>saat</div></div>");
